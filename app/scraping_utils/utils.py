...
def get_next_link(soup):
    BASE_URL = 'https://openstax.org/books/college-physics-2e/pages/'
    ...
    if re.search(unwanted[0], next_link) or re.search(unwanted[1], next_link):     
        return get_next_link(get_soup(BASE_URL + next_link))            # recursive call thru the unwanted pages until a link is found
